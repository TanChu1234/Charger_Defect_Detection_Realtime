...
from UI.Qlabel_handle import ZoomDragLabel
...
"    			}")
        ...
        self.tabWidget.setGeometry(QRect(10, 10, 1900, 991))
        font = QFont()
...
"")
        ...
        self.label_img_out = ZoomDragLabel(self.tab_Onl)
        self.label_img_out.setObjectName(u"label_img_out")
        self.label_img_out.setGeometry(QRect(20, 20, 1231, 920))
        self.label_img_out.setStyleSheet(u"border-radius: 0px;\n"
"border: 1px solid rgb(0, 0, 0);\n"
"background-color:  rgb(0, 0, 127);")
        # Make sure your label can receive focus and events
        self.label_img_out.setFocusPolicy(Qt.StrongFocus)

        # Ensure the widget can receive mouse events
        self.label_img_out.setAttribute(Qt.WA_TransparentForMouseEvents, False)
...
"color: rgb(255, 0, 0);")
        ...
        self.widget.setGeometry(QRect(1260, 20, 631, 921))
        self.widget.setStyleSheet(u"")
        self.label_check = QLabel(self.widget)
        self.label_check.setObjectName(u"label_check")
        self.label_check.setGeometry(QRect(30, 720, 571, 201))
        font2 = QFont()
...
"color: rgb(0, 0, 0);")
        ...
        font5.setBold(True)
        self.bnEnum.setFont(font5)
        self.ComboDevices = QComboBox(self.widget)
        self.ComboDevices.setObjectName(u"ComboDevices")
        self.ComboDevices.setGeometry(QRect(60, 120, 521, 41))
        self.ComboDevices.setFont(font5)
...
"border-radius: 0px;")
        ...
        self.bnStart.setGeometry(QRect(260, 180, 121, 41))
        self.bnStart.setFont(font5)
        self.bnStart.setFocusPolicy(Qt.ClickFocus)
        self.bnStart.setStyleSheet(u"")
        self.bnTrigger = QPushButton(self.widget)
        self.bnTrigger.setObjectName(u"bnTrigger")
        self.bnTrigger.setEnabled(True)
        self.bnTrigger.setGeometry(QRect(420, 180, 131, 41))
        self.bnTrigger.setFont(font5)
        self.bnTrigger.setFocusPolicy(Qt.ClickFocus)
        self.bnTrigger.setStyleSheet(u"")
...
"border-radius: 0px;")
        ...
        self.bnFolder.setGeometry(QRect(440, 250, 111, 31))
        font6 = QFont()
        ...
        self.dir.setGeometry(QRect(100, 250, 311, 31))
        self.dir.setFont(font5)
...
"border-radius: 0px;")
        ...
        self.groupBox.setGeometry(QRect(80, 320, 481, 211))
...
"")
        ...
        self.listWidget_cam = QListWidget(self.tab_Off)
        self.listWidget_cam.setObjectName(u"listWidget_cam")
        self.listWidget_cam.setGeometry(QRect(40, 50, 471, 192))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bnTrigger.setText(QCoreApplication.translate("MainWindow", u"Trigger", None))
